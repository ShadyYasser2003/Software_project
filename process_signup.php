...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        die("كلمة المرور غير متطابقة. يرجى المحاولة مرة أخرى.");
    }

    // التحقق من صحة البريد الإلكتروني
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        die("تنسيق البريد الإلكتروني غير صحيح. يرجى المحاولة مرة أخرى.");
    }
    ...
    if ($result->num_rows > 0) {
        die("البريد الإلكتروني مسجل بالفعل. يرجى استخدام بريد إلكتروني آخر.");
    }
